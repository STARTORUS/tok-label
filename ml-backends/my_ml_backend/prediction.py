...
class BasePredictor(abc.ABC):
    ...
    '''
    @abc.abstractmethod
    def predict(self, task_data: pd.DataFrame) -> List[Prediction]:
        """
...
def start_end_time(predict_result, threshold, postive :bool = True, all_dim :bool = True, time_axis: int = -1):
    ...
    参数:
    -----
    predict_result: 2D array-like / Tensor
...
def convert_to_labelstudio_form(pred_results: List[Prediction], model_version :str = "script_v1") -> List[dict]:
    """
